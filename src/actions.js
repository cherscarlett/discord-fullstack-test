...
export const createReaction = async (channelId, messageId, content) => {
  await axios.post(getRoute(`/channels/${channelId}/messages/${messageId}/reactions`), { channelId, messageId, content });
};
...
export const deleteReaction = async ({ channelId, messageId, reactionId }) => {
  await axios.delete(getRoute(`/channels/${channelId}/messages/${messageId}/reactions/${reactionId}`));
};
